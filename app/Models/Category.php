...
class Category extends Model implements TranslatableContract
{
    ...
    /**
     * Each Category Has Many Bundles "Diplomas"
     */
    ...
    /**
     * quick filter to determine categories where has bundles "Diplomas"
     */
    public function scopeHasBundle($query , bool $has_bundle = true) : bool
    {
