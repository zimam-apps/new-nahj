    ...
    public function checkout(Request $request, $carts = null) //
    {
        ...
        if (!empty($carts) and !$carts->isEmpty()) {
            ...
            if (!empty($order) and $order->total_amount > 0) {
                ...
                /** SPECIAL FOR TAMARA & TABBY */
                $showPaymentChannels = ['Tamara' => \App\PaymentChannels\Drivers\Tamara\Channel::showTamara($order->total_amount)
                ,'Tabby' => \App\PaymentChannels\Drivers\Tabby\Channel::showTabby($order->total_amount)];
                /** END SPECIAL FOR TAMARA & TABBY */
                ...
                $data = [
                    ...
                    'showPaymentChannels' => $showPaymentChannels
                ];
