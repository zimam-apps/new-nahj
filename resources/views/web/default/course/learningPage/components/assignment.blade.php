                            ...
                            <div class="assignment-attachments-post p-15 border rounded-sm mb-15">
                                ...
                                @if(!empty($message->file_path))
                                    <div class="d-flex flex-wrap align-items-center mt-10">
                                        <a href="{{ $message->getDownloadUrl($assignment->id) }}" target="_blank" class="d-flex align-items-center text-gray bg-info-light border px-10 py-5 rounded-pill ml-10 mt-5">
