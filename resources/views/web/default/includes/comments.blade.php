                        ...
                        <div class="rounded-sm border px-20 py-15 mt-30">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="user-inline-avatar d-flex align-items-center mt-10">
                                    ...
                                    <div class="d-flex flex-column ml-5">
                                        <span class="font-weight-500 text-secondary mb-2 mr-2">{{ $reply->user->full_name }}</span>
                                        <span class="font-12 text-gray">
                                ...
                                <div class="d-flex align-items-center">
                                    <span class="font-12 text-gray ml-10">{{ dateTimeFormat($reply->created_at, 'j M Y | H:i') }}</span>
