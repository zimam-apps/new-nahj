@if(!empty($authUser))
    ...
    <div class="custom-dropdown navbar-auth-user-dropdown position-relative ml-50">
        <div class="custom-dropdown-toggle d-flex align-items-center navbar-user cursor-pointer">
            ...
            <span class="font-16 user-name mr-10 text-dark-blue font-14">{{ $authUser->full_name }}</span>
        </div>
        ...
        <div class="custom-dropdown-body pb-10">
            ...
            <ul class="my-8">
                ...
                @else
                    ...
                    @if($authUser->isUser())
                    <li class="navbar-auth-user-dropdown-item">
                        <a href="{{ '/panel/webinars/purchases' }}" class="d-flex align-items-center w-100 px-15 py-10 text-gray font-14 bg-transparent">
                            <img src="/assets/default/img/icons/user_menu/my_courses.svg" class="icons">
                            <span class="ml-5">دوراتي ودبلوماتي</span>
                        </a>
                    </li>
                    @endif
...
@else
    <div class="d-flex align-items-center ml-md-50">
        <a href="/login" class="py-5 px-10 ml-10 text-dark-blue font-14">{{ trans('auth.login') }}</a>
