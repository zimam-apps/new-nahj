            ...
            <div class="rounded-sm shadow mt-20 py-25 px-10 px-md-30">
                ...
                @foreach($carts as $cart)
                    <div class="row mt-5 cart-row">
                        ...
                        <div class="col-6 col-lg-2 d-flex flex-md-column align-items-center justify-content-center">
                            <span class="text-gray d-inline-block d-md-none ml-10 mr-md-0">{{ trans('public.remove') }} :</span>
                        ...
                        <div class="rounded-sm shadow mt-20 py-25 px-20">
                            ...
                            <form action="/carts/coupon/validate" method="Post">
                                ...
                                <button type="submit" id="checkCoupon"
                                        class="btn btn-sm btn-gray mt-50">{{ trans('cart.validate') }}</button>
                            </form>
                        </div>
                    </section>
                </div>
...
@push('scripts_bottom')
    ...
    @if(App\PaymentChannels\Drivers\Tabby\Channel::showTabby($total))
        <div id="tabby"></div>
        ...
        price: '{{ $total }}', // required, price of the product. 2 decimals max for AED|SAR and 3 decimals max for KWD.
