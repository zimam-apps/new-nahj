                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-3 d-flex align-items-center">
                                                @if($topic->pin)
                                                    <div class="topics-lists-card__icons rounded-circle ml-10">
                                    ...
                                    <div class="d-flex align-items-center mt-15">
                                        ...
                                        <div class="ml-10">
                                            <a href="{{ $topUser->getProfileUrl() }}" class="d-block">
                                                <span class="font-14 font-weight-500 text-secondary mb-2 mr-2">{{ $topUser->full_name }}</span>
                                            </a>
                            ...
                            <div class="d-flex align-items-center mt-15">
                                ...
                                <div class="ml-10">
                                    <a href="{{ $popularTopic->getPostsUrl() }}" class="d-block">
                                        <span class="font-14 font-weight-500 text-secondary mb-2 mr-2">{{ $popularTopic->title }}</span>
                                    </a>
