...
@section('content')
    <div class="container">
        <div class="row">
            ...
            {{-- إخفاء الجزء الخاص بعرض صورة الخلفية --}}
            {{--
            ...
            <div class="col-12 col-md-6"  style="margin: auto;">
                ...
                <div class="login-card">
                    <h1 class="font-20 font-weight-bold text-center">{{ trans('site.certificate_validation') }}</h1>
                    <p class="font-14 text-gray mt-15 text-center">{{ trans('site.certificate_validation_hint') }}</p>
