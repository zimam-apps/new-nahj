...
<head>
    ...
    <title>{{ (isset($pageTitle) && $pageTitle) ? $pageTitle.' | ' : '' }}{{ (isset($generalSettings)) ? $generalSettings['site_name'] : '' }}</title>
...
})(window,document,'script','dataLayer','GTM-KNLSXP3Z');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KNLSXP3Z"
