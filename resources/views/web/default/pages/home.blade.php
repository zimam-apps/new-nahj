...
@section('content')
                ...
                @if($heroSection == "2")
                    <div class="row slider-content align-items-center hero-section2 flex-column-reverse flex-md-row">
                        <div class="col-12 col-md-7 col-lg-6">
                            ...
                            <p class="slide-hint text-gray mt-30">{!! nl2br($heroSectionData['description']) !!}</p>
                            ...
                            <form action="/search" method="get" class="d-inline-flex mt-30 mt-lg-30 w-100">
                                <div class="form-group d-flex align-items-center m-0 slider-search p-4-n bg-white w-100">
                                    ...
                                    <button type="submit" class="btn btn-primary" style="border-radius: 38px 0px 38px 38px;">
                                        <i data-feather="search" width="20" height="20" class="ml-10"></i>
                                    </button>
    ...
    @foreach($homeSections as $homeSection)
        ...
        {{-- The Database rules inquiry has been updated so that the latest chapters are the selected for you courses 13-12-2023 --}}
        {{-- دبلومات --}}
        @if($homeSection->name == \App\Models\HomeSection::$diploma and !empty($diplomaWebinars) and !$diplomaWebinars->isEmpty())
            <section class="home-sections home-sections-swiper container">
                <div class="d-flex justify-content-between">
                    <div>
                        <h2 class="section-title">الدبلومات</h2>
                    </div>

                    <a href="/categories/قسم-الدبلومات" class="btn btn-border-white rounded-pill">استعرض الكل</a>
                </div>
                ...
                <div class="mt-10 position-relative">
                    <div class="swiper-container free-webinars-swiper px-12">
                        <div class="swiper-wrapper py-20">
                            ...
                            @foreach($diplomaWebinars as $diplomaWebinar)
                                <div class="swiper-slide">
                                    @include('web.default.includes.webinar.grid-card',['webinar' => $diplomaWebinar])
                                </div>
                            @endforeach
                                ...
                                <div class="shadow-effect">
                                    <div class="instructors-card d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        <div class="instructors-card-info mt-10 text-center">
                                            ...
                                            <div class="mr-1 stars-card d-flex align-items-center justify-content-center mt-10">
                                                @php
                                                    $i = 5;
                                                @endphp
