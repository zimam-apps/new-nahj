...
<section class="mt-50">
    <div class="">
        <h2 class="section-title after-line">{{ trans('update.studyPlan') }}</h2>
    </div>

    <button id="webinarAddFAQ" data-bundle-id="{{ $bundle->id }}" type="button" class="btn btn-primary btn-sm mt-15">{{ trans('update.add_studyPlan') }}</button>
