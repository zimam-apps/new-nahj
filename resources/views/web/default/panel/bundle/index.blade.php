...
@section('content')
    <section>
        ...
        <div class="activities-container mt-25 p-20 p-lg-35">
            <div class="row">
                <div class="col-6 @if($authUser->isOrganization()) col-md-3 @else col-md-6 @endif mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="/assets/default/img/activity/webinars.svg" width="64" height="64" alt="">
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5">{{ !empty($bundles) ? $bundlesCount : 0}}</strong>
                        <span class="font-16 text-gray font-weight-500">عدد الدبلومات</span>
                    </div>
                </div>
                ...
                <div class="col-6 @if($authUser->isOrganization()) col-md-3 @else col-md-6 @endif mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 text-gray font-weight-500">عدد الساعات التدريبية</span>
                    </div>
                </div>
                            ...
                            <div class="webinar-card-body w-100 d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap mt-auto">
                                    ...
                                    <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                        ...
                                        <span class="stat-value">{{ convertMinutesToHourAndMinute($bundle->getBundleDuration()) }} ساعة</span>
                                    </div>
