        ...
        <div class="d-flex align-items-center">
            ...
            @if (!empty($assignment))
                <button type="button" data-item-id="{{ $assignment->id }}"
                    ...
                    class="js-change-content-chapter btn btn-sm btn-transparent text-gray ml-10">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                                    ...
                                    <div class="form-group js-file-path-input {{ (!empty($file) and $file->storage == 's3') ? 'd-none' : '' }}">
                                        <div class="local-input input-group">
                                            <div class="input-group-prepend">
                                                <button type="button"
                                                    class="input-group-text panel-file-manager text-white"
                                                    data-input="file_path{{ !empty($assignment) ? $assignment->id : 'record' }}"
                                                    data-preview="holder">
                                            ...
                                            <input type="text"
                                                ...
                                                id="file_path{{ !empty($assignment) ? $assignment->id : 'record' }}"
                                                value="{{ !empty($assignment) ? $assignment->file : '' }}"
                        ...
                        @if (getFeaturesSettings('sequence_content_status'))
                            ...
                            <div
                                class="js-sequence-content-inputs pl-5 {{ (!empty($assignment) and ($assignment->check_previous_parts or !empty($assignment->access_after_day))) ? '' : 'd-none' }}">
                                <div class="form-group">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <label class="cursor-pointer input-label"
