...
@section('content')
        ...
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            ...
            @if(!$authUser->isUser())
                {{-- <div class="d-flex align-items-center flex-row-reverse flex-md-row justify-content-start justify-content-md-center mt-20 mt-md-0">
                    <label class="mb-0 ml-10 cursor-pointer text-gray font-14 font-weight-500" for="iNotAvailable">{{ trans('panel.i_not_available') }}</label>
    ...
    <section class="dashboard">
        <div class="row">
            ...
            <a href="https://forms.gle/WZEJoWoJnfi3VshJA" target="_blank" class="dashboard-stats rounded-sm panel-shadow p-10 p-md-20 d-flex align-items-center mb-30">
                    <div class="stat-icon comments">
                        <img src="/assets/default/img/icons/comment.svg" alt="">
                    </div>
                    <div class="d-flex flex-column ml-15">
                        <span class="font-16 text-gray font-weight-500">أختبار تحديد المستوى في اللغة الإنجليزية</span>
                    </div>
                </a>
                @endif
                <a href="/panel/webinars/purchases" class="dashboard-stats rounded-sm panel-shadow p-10 p-md-20 d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column ml-15">
                        <span class="font-30 text-secondary">{{ (isset($webinarsCount)) ? $webinarsCount : 0 }}</span>
                        <span class="font-16 text-gray font-weight-500">عدد المشتريات من الدورات والدبلومات</span>
                    </div>
                </a>
