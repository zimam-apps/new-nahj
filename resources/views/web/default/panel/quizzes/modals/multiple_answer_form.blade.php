    ...
    <div class="row">
        <div class="col-12">
            <div class="form-group">
                ...
                <input type="text" dir="{{$quiz->text_direction ?? 'ltr' }}" name="ajax[answers][{{ !empty($answer) ? $answer->id : 'ans_tmp' }}][title]" class=" form-control {{ !empty($answer) ? 'js-ajax-answer-title-'.$answer->id : '' }}" value="{{ !empty($answer) ? $answer->title : '' }}"/>
            </div>
        </div>
    </div>
