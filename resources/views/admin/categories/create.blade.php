...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            @if(request()->is('admin/categories/612/edit'))
                <h1>{{ trans('update.Edit_diplomaSubCategory') }}</h1>
            @else
                                ...
                                <form action="{{ getAdminPanelUrl() }}/categories/{{ !empty($category) ? $category->id.'/update' : 'store' }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title"
                                            ...
                                            placeholder="{{ trans('admin/main.choose_title') }}" readonly/>
                                        @error('title')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="slug"
                                            ...
                                            value="{{ !empty($category) ? $category->slug : old('slug') }}" readonly/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="order"
                                            ...
                                            value="{{ !empty($category) ? $category->order : old('order') }}" readonly/>
                                    ...
                                    <div class="form-group" id="hasSubCategoryContainer">
                                    ...
                                    <div id="subCategories" class="ml-0 {{ (!empty($subCategories) and !$subCategories->isEmpty()) ? '' : ' d-none' }}">
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            ...
                                            <button type="button" class="btn btn-success add-btn"><i class="fa fa-plus"></i> إضافة قسم جديد</button>
                                        </div>
...
@push('scripts_bottom')
    ...
    <script>
        var checkbox = document.getElementById('hasSubCategory');

        document.getElementById('hasSubCategoryContainer').addEventListener('click', function () {
            // إذا كان المربع محددًا، لا تسمح بإلغاء التحديد
            if (checkbox.checked) {
                alert("غير مصرح لك بإلغاء تحديد هذا الحقل");
                // إلغاء الحدث الافتراضي للـcheckbox لمنع التغيير
