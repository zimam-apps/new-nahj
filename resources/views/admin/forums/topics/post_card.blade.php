                ...
                @if(!empty($cardUserBadges) and count($cardUserBadges))
                    <div class="d-flex align-items-center justify-content-center w-100">
                        @foreach($cardUserBadges as $badge)
                            <div class="ml-10 mt-4" data-toggle="tooltip" data-placement="bottom" data-html="true" title="{!! (!empty($badge->badge_id) ? nl2br($badge->badge->description) : nl2br($badge->description)) !!}">
