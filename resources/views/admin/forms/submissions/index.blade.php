                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a class="btn btn-primary" style="color:white;" onclick="exportToExcel()">
                                {{ trans('admin/main.export_xls') }}
                            </a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped font-14" id="exportSubmissions">
                                    <tr>
                                    ...
                                    @foreach($submissions as $submission)
                                        <tr>
                                            ...
                                            <td>{{ !empty($submission->user) ? $submission->user->email : trans('update.guest') }}</td>

                                            <td>{{ !empty($submission->user) ? $submission->user->mobile : trans('update.guest') }}</td>
...
<script>
    function exportToExcel() {
      ...
      var table = document.getElementById("exportSubmissions");
      ...
      XLSX.writeFile(wb, "submissions_table.xlsx");
    }
</script>
@endpush
